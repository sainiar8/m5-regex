...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        boolean oneLower = Pattern.matches(".*[a-z].*", str);
        boolean oneUpper = Pattern.matches(".*[A-Z].*", str);
        boolean containsDigit = Pattern.matches(".*[0-9].*", str);

        return oneLower && oneUpper && containsDigit;
    }
